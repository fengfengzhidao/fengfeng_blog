...
urlpatterns = [
    ...
    path('get_seven_data/', admin_data.get_seven_data),  # 获取在线人数
    ...
    path('send_email/', api_email.ApiEmail.as_view()),  # 删除封面
    path('perfect_information/', user.EditUserInfoView.as_view()),  # 删除封面
